...
function Projects(props) {
  ...
  const [proj0Point2, setProj0Point2] = useState({
    value: 'Completed after 5 months of studying JavaScript.',
    edit: false,
  });
  ...
  const [proj1Point0, setProj1Point0] = useState({
    value: 'A game built with vanilla Javascript, HTML, and CSS',
    edit: false,
  });
  ...
  const [proj1Point2, setProj1Point2] = useState({
    value: 'Placed 2nd overall out of 37 games submitted for The GameHackathon',
    edit: false,
  });
