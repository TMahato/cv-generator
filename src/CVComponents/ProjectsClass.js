  ...
  constructor(props){
    ...
    this.state = {
      proj0: {
        ...
        point2: 'Completed after 5 months of studying JavaScript.',
        pointEdit2: false,
      },
      ...
      proj1: {
        ...
        point0: 'A game built with vanilla Javascript, HTML, and CSS',
        pointEdit0: false,

        point1: 'Collaborated with a team of 3 and utilized Git and GitHub for discussion and conflicts resolution',
        pointEdit1: false,

        point2: 'Placed 2nd overall out of 37 games submitted for The GameHackathon',
        pointEdit2: false,
      },
    }
  }
